...
# Create a brigde networ in Docker
...
#### TO DO: Add gcloud install docker, cloud.google.com/cli 
USER jenkins
...
echo "Successfully Installed Jenkins Docker."
  
# Matt
# Remove networks, running containers and images
